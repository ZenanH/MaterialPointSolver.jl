...
function init_mpts(; ϵ::Symbol=:double, ξ, h, G, FLIP, nid=[0], ρs, Ks=[0.0], 
    ...
    return Particle{T1, T2, Array{T1, 1}, Array{T2, 1}, Array{T2, 2}, NamedTuple}(
        np, h, G, FLIP, nid, ϵq, ϵk, Ω, Ω0, ρs, ρs0, cfl, Ks, Es, Gs, c, cr, ϕ, ϕr, ψ, Hp, 
        σt, ξ, ξ0, σij, vs, vmin, vmax, F, ext)
end